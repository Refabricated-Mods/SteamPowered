...
public class CastIronFlywheelInstance extends KineticTileInstance<FlywheelTileEntity> implements DynamicInstance {
    ...
    public CastIronFlywheelInstance(MaterialManager modelManager, FlywheelTileEntity tile) {
        ...
        wheel = getTransformMaterial().getModel(SPBlockPartials.CAST_IRON_FLYWHEEL, referenceState.getValue(HORIZONTAL_FACING)).createInstance();
        ...
        if (connection != null) {
            ...
            upperRotating = mat.getModel(SPBlockPartials.CAST_IRON_FLYWHEEL_UPPER_ROTATING).createInstance();
            lowerRotating = mat.getModel(SPBlockPartials.CAST_IRON_FLYWHEEL_LOWER_ROTATING).createInstance();
            upperSliding = mat.getModel(SPBlockPartials.CAST_IRON_FLYWHEEL_UPPER_SLIDING).createInstance();
            lowerSliding = mat.getModel(SPBlockPartials.CAST_IRON_FLYWHEEL_LOWER_SLIDING).createInstance();
