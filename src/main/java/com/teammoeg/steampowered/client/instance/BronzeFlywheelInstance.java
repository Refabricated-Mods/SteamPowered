...
public class BronzeFlywheelInstance extends KineticTileInstance<FlywheelTileEntity> implements DynamicInstance {
    ...
    public BronzeFlywheelInstance(MaterialManager modelManager, FlywheelTileEntity tile) {
        ...
        wheel = getTransformMaterial().getModel(SPBlockPartials.BRONZE_FLYWHEEL, referenceState.getValue(HORIZONTAL_FACING)).createInstance();
        ...
        if (connection != null) {
            ...
            upperRotating = mat.getModel(SPBlockPartials.BRONZE_FLYWHEEL_UPPER_ROTATING).createInstance();
            lowerRotating = mat.getModel(SPBlockPartials.BRONZE_FLYWHEEL_LOWER_ROTATING).createInstance();
            upperSliding = mat.getModel(SPBlockPartials.BRONZE_FLYWHEEL_UPPER_SLIDING).createInstance();
            lowerSliding = mat.getModel(SPBlockPartials.BRONZE_FLYWHEEL_LOWER_SLIDING).createInstance();
